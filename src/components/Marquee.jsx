export default function Marquee() {
  return (
    <div className="mt-[10rem] w-dvw overflow-hidden whitespace-nowrap bg-amber-400 hover:bg-gray-800 h-96 flex items-center relative cursor-pointer transition-all duration-300">
